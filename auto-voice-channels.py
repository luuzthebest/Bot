            ...
            if in_favor >= vk['required_votes']:
                ...
                try:
                    ...
                    try:
                        await vk['message'].edit(
                            content="‼ **Votereject** failed - A `{}` error was encountered.".format(
                                type(e).__name__))
                ...
                try:
                    await vk['message'].edit(content=(
                        "‼ **VoteReject** ‼\n"
                        "{} was **rejected** from {}'s channel{}.{}".format(
                ...
                await func.server_log(
                    guild,
                    "👢 {} (`{}`) has been **rejected** from {}'s channel.".format(
                ...
                try:
                    await vk['message'].edit(
                        content="‼ **VoteReject** timed out: Insufficient votes received "
