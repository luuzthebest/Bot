    ...
    if not params:
        ...
        if not ctx['admin'] and ctx['guild'].id != support_server_id:
            ...
            text = (
                ...
                " ·  **<PREFIX> reject `@USER`** - "
                "Start a votereject to remove someone from your channel.\n\n"
        ...
        for i, s in enumerate(sections):
            ...
            if s.startswith("\n**-- Quickstart --**\n") and can_embed:
                embed = discord.Embed(
                    ...
                    description="❤ If you like this bot and want to help keep it alive, [support us on 17 Dollars](https://discord.gg/Rw2nYydFwJ) :)")
        ...
        if c in commands:
            ...
            if commands[c].sapphire_required and not ctx['sapphire']:
                await channel.send(
                    ...
                    "amazing features: <https://discord.gg/Rw2nYydFwJ>"
                )
            ...
            e.add_field(
                name=" ·  `PLAYERS>number`",
                value="💎 [*17 Dollars only.*](https://discord.gg/Rw2nYydFwJ) Check if the number of players in your game "
            ...
            e.add_field(
                name=" ·  `MAX>number`",
                value="💎 [*17 Dollars only.*](https://discord.gg/Rw2nYydFwJ) Check if the maximum number of players "
            ...
            e.add_field(
                name=" ·  `RICH`",
                value="💎 [*17 Dollars.*](https://discord.gg/Rw2nYydFwJ) Whether or not the current game uses "
            ...
            e.description = (
                ...
                "please ask me in the [support server](https://discord.gg/Rw2nYydFwJ). "
